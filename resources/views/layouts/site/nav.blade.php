                ...
                <div class="dropdown-menu m-0 overflow-auto" style="max-height: 300px;">
                    ...
                    @foreach ($team_categories as $team_category)
                        <a href="{{ route('site.about.team', encrypt($team_category->id)) }}"
                            class="dropdown-item {{ $currentSlug == $team_category->name ? 'active' : '' }}">{{ $team_category->name }}</a>
                    @endforeach
                </div>
            </div>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0 overflow-auto" style="max-height: 300px;">
                    ...
                    <a href="{{ route('page', 'british-fam-college') }}"
                        class="dropdown-item {{ $currentSlug === 'british-fam-college' ? 'active' : '' }}">FAM
                        College-UK</a>
                </div>
            </div>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0 overflow-auto" style="max-height: 300px;">
                    <a href="{{ route('site.business_and_innovation_ecosystem.consulting_services.index', 'smart-consultancies') }}"
                        class="dropdown-item {{ $currentSlug === 'smart-consultancies' ? 'active' : '' }}">Integrated
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0 overflow-auto" style="max-height: 300px;">
                    <a href="{{ route('page', 'business-partnerships') }}"
                        class="dropdown-item {{ $currentSlug === 'business-partnerships' ? 'active' : '' }}">Our
                        Regional Offices</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu m-0 overflow-auto" style="max-height: 300px;">
                    ...
                    <a href="{{ route('site.smart_training.index', 'professional-training') }}"
                        class="dropdown-item {{ $currentSlug === 'professional-training' ? 'active' : '' }}">Certification
                        Of Professional
                        Training </a>
